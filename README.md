...
### Machine Learning & Data Science | LLMs • RAG • Computer Vision | Full-Stack (Python + TypeScript)

<!-- Profile view counter -->
<a href="https://github.com/arpitraj18">
  <img src="https://komarev.com/ghpvc/?username=arpitraj18&label=Profile%20views&color=0e75b6&style=flat" alt="arpitraj18" />
</a>

- 🔭 I'm currently working on **[incident-investigator](https://github.com/arpitraj18/incident-investigator)** — an AI system for log ingestion, anomaly detection, and incident root-cause analysis using **RAG** and **LangGraph**
- 🌱 I'm currently learning **LLM agents, Retrieval-Augmented Generation, MLOps, and deep learning for computer vision**
...
A quick tour across the different areas I work in:

**🤖 AI / LLMs / Agents**
- [incident-investigator](https://github.com/arpitraj18/incident-investigator) — RAG + LangGraph system for log analysis & incident root-cause

**📊 Machine Learning & Data Science**
- [ML-projects-learning](https://github.com/arpitraj18/ML-projects-learning) — hands-on ML projects & experiments
- [data-science-material](https://github.com/arpitraj18/data-science-material) — data science notebooks & resources
- [TensorTonic-Solutions](https://github.com/arpitraj18/TensorTonic-Solutions) — my solutions to TensorTonic problems

**👁️ Computer Vision / Deep Learning**
- [ppe-detector](https://github.com/arpitraj18/ppe-detector) — PPE (safety gear) detection
- [curb-parking-intelligence](https://github.com/arpitraj18/curb-parking-intelligence) — parking analysis from visual/data inputs

**📈 Data Dashboards & Analytics**
- [ipl-dashboard](https://github.com/arpitraj18/ipl-dashboard) — IPL cricket analytics dashboard
- [atomberg_dashboard](https://github.com/arpitraj18/atomberg_dashboard) — data dashboard
- [dominance-in-f1](https://github.com/arpitraj18/dominance-in-f1) — Formula 1 dominance analysis

**🌐 Web / Full-Stack (TypeScript)**
- [atomquest](https://github.com/arpitraj18/atomquest) — TypeScript web application
- [atomquest-video-support](https://github.com/arpitraj18/atomquest-video-support) — video support module

**🧮 DSA & Python Tooling**
- [dsa-sol](https://github.com/arpitraj18/dsa-sol) — data structures & algorithms solutions
- [atomberg-battery-checker](https://github.com/arpitraj18/atomberg-battery-checker) · [atomberg_assignment](https://github.com/arpitraj18/atomberg_assignment) — Python utilities & assignments
...
<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=arpitraj18&" alt="github streak" />
</p>
